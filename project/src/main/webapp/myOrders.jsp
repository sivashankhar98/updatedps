...
try
{
	...
	ResultSet rs=st.executeQuery("select * from carts inner join products where carts.product_id=products.id and carts.email='"+email+"' and carts.orderDate is not NULL");
	while(rs.next())
	{
		sno=sno+1;
