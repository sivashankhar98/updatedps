...
try{
	...
	ResultSet rs1=st.executeQuery("select * from carts product_id='"+product_id+"' and email='"+email+"' and address is NULL");
	while(rs1.next())
	{
	...
	if(z==1)
	{
		st.executeUpdate("update carts set total='"+cart_total+"',quantity='"+quantity+"'where product_id='"+product_id+"' and email='"+email+"' and address in NULL");
